...
void init(GLFWwindow *window)
{
    ...
    // ------------------------------------
    ourShader.LoadShaderStage("7.1.camera.vs", GL_VERTEX_SHADER);
    ourShader.LoadShaderStage("7.1.camera.fs", GL_FRAGMENT_SHADER);
    ourShader.Link();
...
void render()
{
    ...
    view = glm::lookAt(glm::vec3(-5.0f, 0.0f, 5.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    // view = glm::lookAt(glm::vec3( 5.0f, 0.0f, 5.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
...
ExamleMain("camera_circle", SCR_WIDTH, SCR_HEIGHT)