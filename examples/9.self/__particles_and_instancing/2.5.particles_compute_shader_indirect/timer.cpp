...
double Timer::elapsed_time() { return elapsed_time_sec(); }

double Timer::elapsed_time_sec() { return elapsed_time_microsec() * 0.000001; }

double Timer::elapsed_time_milisec() { return elapsed_time_microsec() * 0.001; }
