...
void init(GLFWwindow *window)
{
    ...
    // -------------------------
    texture2D.FromImage(FileSystem::getPath("resources/textures/window.png").c_str(),false);
...
ExamleMain("transparent_rendering_transparent_prez", SCR_WIDTH, SCR_HEIGHT)
