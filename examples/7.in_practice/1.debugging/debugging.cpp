...
int main()
{
    ...
    if (flags & GL_CONTEXT_FLAG_DEBUG_BIT) // GL_KHR_debug
    {
        glEnable(GL_DEBUG_OUTPUT);
        glEnable(GL_DEBUG_OUTPUT_SYNCHRONOUS_ARB); // makes sure errors are displayed synchronously
        glDebugMessageCallbackARB(glDebugOutput, nullptr); // GL_ARB_debug_output
